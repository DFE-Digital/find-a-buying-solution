...
namespace :contentful do
  ...
  task update_solution_with_primary_category: :environment do
    ...
    all_categories = Category.all.map { |cat|
      [cat.title, cat.id]
    }.to_h
    ...
    primary_categories = {
      ...
      "Debt resolution services" => "Consultancy services",
      "LED lighting" => "Energy",
    ...
    entries.each do |entry|
      ...
      if categories.count == 1
        ...
        puts "primary_category #{cat_name}"
        ...
        puts "Update multi primary_category"
      end
